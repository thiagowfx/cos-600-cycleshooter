...
bool Controller::frameRenderingQueued(const Ogre::FrameEvent &evt) {
    ...
    // pathManager updates
    pathManager->monsterPathUpdate(evt.timeSinceLastFrame, logicManager->getPlayerPosition(), logicManager->getMonsterPosition(), context);
...
void Controller::createGameElements() {
    ...
    // create a skybox
    getSceneManager()->setSkyBox(true, "Cycleshooter/NightySky");
